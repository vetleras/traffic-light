...
public class Synchronizer implements IStateMachine {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Connected to " + cs1.getRemoteSocketAddress());
			Socket cs2 = serverSocket.accept();
			System.out.println("Connected to " + cs2.getRemoteSocketAddress());
			Socket cs3 = serverSocket.accept();
			System.out.println("Connected to " + cs3.getRemoteSocketAddress());
